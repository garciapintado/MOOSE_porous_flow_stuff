 ...
 */
class PorousFlowEnergyTimeDerivativeNopore : public TimeKernel
{
public:
  static InputParameters validParams();

  PorousFlowEnergyTimeDerivativeNopore(const InputParameters & parameters);
...
protected:
  ...
  /// Whether to neglect contribution of fluid phases (e.g. porosity=0 blocks)
  const bool _neglect_porosity;
