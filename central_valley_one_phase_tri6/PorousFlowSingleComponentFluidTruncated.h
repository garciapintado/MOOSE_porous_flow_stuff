 ...
 */
class PorousFlowSingleComponentFluidTruncated : public PorousFlowFluidPropertiesBase
{
public:
  static InputParameters validParams();

  PorousFlowSingleComponentFluidTruncated(const InputParameters & parameters);
...
protected:
  ...
  /// Minimum value [Pa] to be used as pressure value input for the fluid properties module
  const Real _min_pressure;
    
  /// Minimum value [K] to be used as temperature value input for the fluid properties module
  const Real _min_temperature;
  
  /// Maximum value [K] to be used as temperature value input for the fluid properties module
