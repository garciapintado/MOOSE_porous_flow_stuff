...
#include "PorousFlowEnergyTimeDerivativeNopore.h"

#include "MooseVariable.h"

registerMooseObject("PorousFlowApp", PorousFlowEnergyTimeDerivativeNopore);

InputParameters
PorousFlowEnergyTimeDerivativeNopore::validParams()
{
  InputParameters params = TimeKernel::validParams();
  params.addParam<bool>("neglect_porosity",
                        false,
                        "If you set this to true, posority is assumed to be zero "
                        "so that fluid contribution is neglected");
...
PorousFlowEnergyTimeDerivativeNopore::PorousFlowEnergyTimeDerivativeNopore(const InputParameters & parameters)
  : TimeKernel(parameters),
    _dictator(getUserObject<PorousFlowDictator>("PorousFlowDictator")),
    _var_is_porflow_var(_dictator.isPorousFlowVariable(_var.number())),
    //_num_phases(_dictator.numPhases()),
    _neglect_porosity(getParam<bool>("neglect_porosity")),
    _num_phases(_neglect_porosity
                       ? 0
                       : _dictator.numPhases()),
...
Real
PorousFlowEnergyTimeDerivativeNopore::computeQpResidual()
{
...
Real
PorousFlowEnergyTimeDerivativeNopore::computeQpJacobian()
{
...
Real
PorousFlowEnergyTimeDerivativeNopore::computeQpOffDiagJacobian(unsigned int jvar)
{
...
Real
PorousFlowEnergyTimeDerivativeNopore::computeQpJac(unsigned int pvar) const
{
