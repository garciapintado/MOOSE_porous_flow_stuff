...
#
# mpiexec -np 4 porousflow-opt -i archaea01.i 
#                                          
# simple synthetic setup of hydrothermal circulation model with central valley topography
# unsaturated TH simulation
# step 01a simply brings the model to equilibrium with a standard geothermal gradient 
# with 'mpi -n 6' this has taken computing time in my iMAC, with last timesteps being dt = 3.2e+10
# thus we can consider the final step here to be an equilibrium state under a standard geothermal gradient 
#
